    ...
    <div class="sidenav text-wrap p-0 m-0">
        ...
        <nav class="nav nav-pills flex-column text-center p-0 m-0">
            ...
            <a class="nav-link px-3 py-3 px-0 my-2 rounded-4" href="../app/index.php?page=product-list">Danh sách
                khách sạn</a>
            <a class="nav-link px-3 py-3 px-0 my-2 rounded-4 active" href="../app/index.php?page=add-product">Thêm khách sạn</a>
    ...
    <div class="maincontent container-fluid">
        ...
        <form class="row g-3" name="addproductform" method="post" action="../app/index.php?page=add-product&action=submit" <?php
            ...
            <div class="form__avatar col-lg-4">
                <div class="mb-4 d-flex flex-column align-items-start">
                    <label class="form-label m-0 mb-2" for="avatar" style="width: 200px;">Chọn hình ảnh (nhập link)</label>
                    <input type="text" name="productimage" class="form-control mb-1" style="width: 350px;" id="avatar" onchange="displayAvatarFromInputLink(this.value, 'selectedAvatar')" required />
                    <div>
